...
function renderRanking() {
  ...
  const fireIconSvg = `<svg class="fire-icon" viewBox="0 0 24 24" width="24" height="24" aria-hidden="true"><path d="M12 2c1.4 3.4-2.6 4.6-3 8.3A3.2 3.2 0 0 0 12 13.8a3.2 3.2 0 0 0 3.2-3.2c0-.8-.3-1.5-.6-2 1.6 2.7 3.8 4 3.8 7.3a6.4 6.4 0 1 1-12.8 0C5.8 10.8 11 9 11.2 3.2 11.3 2.4 11.6 2 12 2Z" fill="var(--accent)"/><path d="M12.3 12.2c.5 1.1-1.1 1.6-1.3 3a1.6 1.6 0 0 0 3.1.3c.1-.4 0-.8-.2-1.1.9 1.2 1.7 1.9 1.5 3.3a2.9 2.9 0 0 1-5.7-.8c.3-2.4 2.4-2.9 2.6-4.7Z" fill="#D8390F"/></svg>`;
