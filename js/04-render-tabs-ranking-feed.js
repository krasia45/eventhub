...
function renderRanking() {
  ...
  const fireIconSvg = `<svg class="fire-icon" viewBox="0 0 32 32" width="30" height="30" aria-hidden="true"><defs><linearGradient id="fireGradBack" x1="0.5" y1="1" x2="0.5" y2="0"><stop offset="0%" stop-color="#7A0C06"/><stop offset="60%" stop-color="#E8480F"/><stop offset="100%" stop-color="#FF9A2E"/></linearGradient><linearGradient id="fireGradFront" x1="0.5" y1="1" x2="0.5" y2="0"><stop offset="0%" stop-color="#C41807"/><stop offset="45%" stop-color="#FF6F00"/><stop offset="78%" stop-color="#FFC233"/><stop offset="100%" stop-color="#FFF6C9"/></linearGradient></defs><path d="M20 3c2.6 4.6-2 6.8-3.8 11.2-1.6 4 .8 8.2 4.4 9.2a4.5 4.5 0 0 0 5.6-4.4c0-1-.3-1.8-.6-2.5 3 3 6 6 5.6 10.6-.5 5.6-5.6 9.4-11 8.6-5-.7-8.6-5-8.3-10 .4-7.6 7.4-9.6 7.3-18.4 0-1.7.3-3 1.8-4.3Z" fill="url(#fireGradBack)" opacity="0.55"/><path d="M13.6 1.4c2.3 4.2-2 6.2-3.6 10.2-1.6 3.8.4 7.7 3.9 8.7a4 4 0 0 0 5.1-4c0-.9-.2-1.7-.5-2.3 2.9 2.9 5.9 5.6 5.6 10-.4 4.9-4.7 8.3-9.6 7.8-4.6-.5-8.1-4.4-7.9-9.1.3-7.1 6.9-8.9 6.8-17.1 0-1.6.3-2.7 1.2-4.2Z" fill="url(#fireGradFront)"/><path d="M14.4 12c.7 1.4-1 2.2-1.2 4a2.1 2.1 0 0 0 4.1.5c.1-.5 0-1-.2-1.4 1.3 1.5 2.3 2.6 2 4.6a3.7 3.7 0 0 1-7.4-.7c.5-3.2 3.2-3.8 2.7-7Z" fill="#FFFAE0" opacity="0.9"/><circle class="spark spark1" cx="23" cy="6" r="1.1" fill="#FFC233"/><circle class="spark spark2" cx="8" cy="4" r="0.9" fill="#FF9A2E"/></svg>`;
